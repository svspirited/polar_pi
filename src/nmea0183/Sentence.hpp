...
//   DECLARE_DYNAMIC( SENTENCE )
   ...
   public:
      ...
      */
      ...
      virtual NMEA0183P_BOOLEAN Boolean( int field_number ) const;
      ...
      virtual NMEA0183P_BOOLEAN IsChecksumBad( int checksum_field_number ) const;
      ...
      */
      ...
      virtual const SENTENCE& operator += ( NMEA0183P_BOOLEAN boolean );
